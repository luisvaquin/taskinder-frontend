...
export const Title = ({ children }) => {
        ...
        () => (  // Configuración de la animación cuando el elemento entra en la vista
            {
                ...
                to: {
                    opacity: 1,
                    amount: 0.5,
                    y: 0  // Prueba con un umbral menos sensible
                    // Cambia esta parte
                },
            }
        ),
        {
            rootMargin: '-10px 0px -15% 0px',  // Margen de visualización para el observador
    ...
    return (
        <animated.h2 ref={ref} style={springs}>  {/* Aplica la animación */}
